...
fileprivate struct UniffiCallbackInterfaceMsgCall {

    // Create the VTable using a series of closures.
    // Swift automatically converts these into C callback functions.
    static var vtable: UniffiVTableCallbackInterfaceMsgCall = UniffiVTableCallbackInterfaceMsgCall(
        receiveMsg: { (
            uniffiHandle: UInt64,
            record: RustBuffer,
            ...
            let makeCall = {
                ...
                return uniffiObj.receiveMsg(
                     record: try FfiConverterTypeDBInsertIMModel_lift(record)
                )
            }
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterCallbackInterfaceMsgCall {
